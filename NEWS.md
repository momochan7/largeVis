### largeVis 0.1.10
* `projectKNNs` now supports momentum training and lets the user select the negative sampling method.  Momentum can make the sgd phase of the algorithm substantiallly faster. 
